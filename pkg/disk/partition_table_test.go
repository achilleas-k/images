	...
	testCases := map[string]testCase{
		...
		"plain-reqsizes": {
			...
			options: &disk.CustomPartitionTableOptions{
				DefaultFSType:      disk.FS_XFS,
				BootMode:           platform.BOOT_HYBRID,
				RequiredSizes:      map[string]uint64{"/": 1 * common.GiB, "/usr": 2 * common.GiB}, // the default for our distro definitions
				PartitionTableType: "dos",
			},
			expected: &disk.PartitionTable{
				Type: "dos",
				Size: 222*common.MiB + 3*common.GiB,
				UUID: "0194fdc2-fa2f-4cc0-81d3-ff12045b73c8",
				Partitions: []disk.Partition{
					{
						Start:    1 * common.MiB, // header
		...
		"plain+": {
			...
			options: &disk.CustomPartitionTableOptions{
				...
				RequiredSizes:      map[string]uint64{"/": 3 * common.GiB},
			},
			expected: &disk.PartitionTable{
				Type: "gpt",
				Size: 222*common.MiB + 3*common.GiB + common.MiB, // start + size of last partition + footer
				...
				Partitions: []disk.Partition{
					...
					{
						Start:    222 * common.MiB,
						Size:     3*common.GiB + common.MiB - (disk.DefaultSectorSize + (128 * 128)), // grows by 1 grain size (1 MiB) minus the unaligned size of the header to fit the gpt footer
						Type:     disk.FilesystemDataGUID,
		...
		"lvm": {
			...
			expected: &disk.PartitionTable{
				...
				UUID: "0194fdc2-fa2f-4cc0-81d3-ff12045b73c8",
				Size: 714*common.MiB + 168*common.MiB + common.MiB, // start + size of last partition (VG) + footer
				Partitions: []disk.Partition{
					{
						Start:    1 * common.MiB, // header
						Size:     1 * common.MiB,
					...
					{
						Start:    714 * common.MiB,
						Size:     168*common.MiB + common.MiB - (disk.DefaultSectorSize + (128 * 128)), // the sum of the LVs (rounded to the next 4 MiB extent) grows by 1 grain size (1 MiB) minus the unaligned size of the header to fit the gpt footer
						...
						Payload: &disk.LVMVolumeGroup{
							...
							LogicalVolumes: []disk.LVMLogicalVolume{
								{
									Name: "varloglv",
									Size: 12 * common.MiB, // rounded up to next extent (4 MiB)
									Payload: &disk.Filesystem{
										Label:        "var-log",
										Type:         "xfs",
										Mountpoint:   "/var/log",
								...
								{
									Name: "rootlv",
									Size: 52 * common.MiB, // rounded up to the next extent (4 MiB)
									Payload: &disk.Filesystem{
										Label:        "root",
										Type:         "xfs",
										Mountpoint:   "/",
		...
		"lvm-multivg": {
			...
			expected: &disk.PartitionTable{
				Type: "gpt", // default when unspecified
				UUID: "0194fdc2-fa2f-4cc0-81d3-ff12045b73c8",
				Size: 818*common.MiB + 16*common.MiB + 3*common.GiB + common.MiB, // start + size of last partition (VG) + footer
				Partitions: []disk.Partition{
					{
						Start:    1 * common.MiB, // header
						Size:     1 * common.MiB,
					...
					{
						Start:    818 * common.MiB,                                                                   // the root vg is moved to the end of the partition table by relayout()
						Size:     3*common.GiB + 16*common.MiB + common.MiB - (disk.DefaultSectorSize + (128 * 128)), // the sum of the LVs (rounded to the next 4 MiB extent) grows by 1 grain size (1 MiB) minus the unaligned size of the header to fit the gpt footer
						Type:     disk.LVMPartitionGUID,
						UUID:     "32f3a8ae-b79e-4856-b659-c18f0dcecc77",
						Bootable: false,
						Payload: &disk.LVMVolumeGroup{
					...
					{
						Start:    714 * common.MiB,
						Size:     104 * common.MiB, // the sum of the LVs (rounded to the next 4 MiB extent) grows by 1 grain size (1 MiB) minus the unaligned size of the header to fit the gpt footer
						Type:     disk.LVMPartitionGUID,
		...
		"btrfs": {
			...
			expected: &disk.PartitionTable{
				Type: "gpt",
				Size: 714*common.MiB + 230*common.MiB + common.MiB, // start + size of last partition + footer
				UUID: "0194fdc2-fa2f-4cc0-81d3-ff12045b73c8",
				Partitions: []disk.Partition{
					{
						Start:    1 * common.MiB, // header
					...
					{
						Start:    714 * common.MiB,
						Size:     231*common.MiB - (disk.DefaultSectorSize + (128 * 128)), // grows by 1 grain size (1 MiB) minus the unaligned size of the header to fit the gpt footer
						Type:     disk.FilesystemDataGUID,
						UUID:     "e2d3d0d0-de6b-48f9-b44c-e85ff044c6b1",
						Bootable: false,
						Payload: &disk.Btrfs{
		...
		"autorootbtrfs": {
			...
			expected: &disk.PartitionTable{
				...
				Partitions: []disk.Partition{
					...
					{
						Start:    513 * common.MiB,
						Size:     1*common.MiB - (disk.DefaultSectorSize + (128 * 128)), // grows by 1 grain size (1 MiB) minus the unaligned size of the header to fit the gpt footer
						Type:     disk.FilesystemDataGUID,
						UUID:     "e2d3d0d0-de6b-48f9-b44c-e85ff044c6b1",
						Bootable: false,
						Payload: &disk.Btrfs{
